...
function add_theme_scripts()
{
    ...
    wp_enqueue_style('fslightbox-css', get_theme_file_uri() . '/assets/css/fslightbox.min.css');
    ...
    wp_enqueue_script('menu-nav-scroll-js', get_theme_file_uri() . '/assets/js/menu-nav-scroll.js', array('jquery'), '1.0', true);

    wp_enqueue_script('fslightbox-js', get_theme_file_uri() . '/assets/js/fslightbox.min.js', array('jquery'), '1.0', true);
}
